...
namespace DataModel
{
	...
	public class Order
	{
		...
		/// FK_Orders_Customers
		/// </summary>
		[Association(ThisKey = nameof(CustomerId), OtherKey = nameof(DataModel.Customer.CustomerId))]
		public Customer? Customer { get; set; }

		/// <summary>
		/// FK_Orders_Employees
		/// </summary>
		[Association(ThisKey = nameof(EmployeeId), OtherKey = nameof(DataModel.Employee.EmployeeId))]
